                            ...
                            m('.card-content', {
                                class: settingsService.getIsDarkMode() ? 'white-text' : ''
                                    ...
                                    m('span.card-title', 'About Bible Scout'), [
                                        ...
                                        m('h6', 'To ', m('a[href="https://play.google.com/store/apps/details?id=huss.john.djbible&hl=en_US"]', 'DJ Bible Reading Plan'), ' which inspired this app to care on its legacy.',
                                        ),
